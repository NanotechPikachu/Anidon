...
function Anime() {
 ...
 // console.log(!data.title);
  ...
  return (
    ...
    <div className="mt-2 flex flex-col md:grid md:grid-flow-row md:grid-cols-3 overflow-hidden md:gap-4"> {l?.map((x, index) => (<div key={index} className="p-2"><p className="border-2">Episode: {x} </p></div>)) || 'No information'}</div>
    </div>
    </div>
