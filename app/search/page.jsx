...
function Result() {
  ...
  return (
    ...
    <div key={index} className="border-2 border-violet-700 overflow-hidden flex flex-col cursor-pointer w-24 md:w-36 h-44 md:h-64 hide-scroll relative" onClick={() => changePage(x.id)}>
