...
export default function NavBar() {
  ...
  return (
    ...
    <div className={`fixed top-0 right-0 m-3 p-1 text-white border-2 border-violet-900 hover:border-purple-500 ${isOpen ? 'hidden' : 'block'}`}
    ...
    <div
      ...
      >
    <div className="absolute text-white top-0 left-0 m-3 p-1 border-2 border-violet-900 hover:border-purple-500"
          onClick={toggleNavBar}>
