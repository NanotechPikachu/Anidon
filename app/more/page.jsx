      ...
      <div className="ml-6 mr-6 mt-6 mb-20">
        <>
          ...
          <div className="mt-16 md:mt-24">
            ...
            <div className="hover:small-scroll mt-6 mb-4 grid grid-flow-col auto-cols-max max-w-screen grid-rows-1 gap-3 md:gap-6 overflow-x-auto h-44 md:h-72">
              {m.map((x, index) => (
                <div
                  className="overflow-hidden flex flex-col flex-shrink-0 cursor-pointer sm:w-44 sm:h-72 h-60 w-36 hide-scroll relative rounded-md"
